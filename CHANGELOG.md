## v0.6.8 / 20260817
- 🎨 适配思源v3.8.1 office 公式粘贴
- 🎨 优化菜单

## v0.6.5 / 20260815
- 🎨 保留富文本颜色根据office来源和其他来源进行区分
- 🎨 剪切板调整标题级别添加无标题，把标题都变为加粗
## v0.6.4 / 20260809
- 🐛 思源笔记 3.7.x/3.8.x 中，开启插件，粘贴公式时，无法立即正确渲染；但关闭笔记重新打开后可以正确渲染 [#34](https://github.com/Achuan-2/siyuan-plugin-text-process/issues/34)
...
- 🎨 粘贴自动识别：支持链接自动识别
- 🎨 块菜单和选中文本右键支持链接自动识别
- 🎨 对于思源笔记本身的文本粘贴操作，不进行处理时不提醒粘贴处理操作
- 🐛 修复选中文本单独处理没保存的问题
...
- 🎨 给选中的文本右键菜单添加去除上标、去除空格、去除换行、英文符合转中文、中文符号转英文、全角转半角、半角转全角功能
- 🎨 改进英文字符转中文字符和半角转全角效果，数字之间的.不参与转换，比如7.28，不应该被转换
- 🎨 合并块保留富文本样式

## v0.4.0 / 20251221

- 🎨 改进英文符号转中文，英文冒号没有成功转换为中文
- 🎨 半角转全角
